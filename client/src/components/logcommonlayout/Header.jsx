          ...
          >
            ...
            <div className="hidden sm:block text-left max-w-[160px] truncate">
              <p className="text-sm font-medium text-gray-900 dark:text-white truncate">
                {user?.username || "Welocm"}
              </p>
              <p className="text-xs text-gray-500 dark:text-gray-400 truncate">
                {user?.email || "wel@school.edu"}
              </p>
            </div>
            ...
            <AnimatePresence>
              {openDropdown && (
                ...
                >
                  ...
                  <Link to="/logout">
                    <button className="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-100 dark:hover:bg-red-600/10">
                      Logout
                    </button>
                  </Link>
                </motion.div>
